...
namespace BillyBot.MicroTasks
{
    public class WarpPrismOffenseTask : MicroTask
    {
        ...
        public WarpPrismOffenseTask(DefaultSharkyBot defaultSharkyBot, IMicroController microController, WarpPrismMicroController warpPrismMicroController, List<DesiredUnitsClaim> desiredUnitsClaims, float priority, bool enabled = true)
        {
