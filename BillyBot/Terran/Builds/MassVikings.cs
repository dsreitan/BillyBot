...
public class MassVikings : TerranSharkyBuild
{
    ...
    public override void StartBuild(int frame)
    {
        ...
        MacroData.AddOnSwaps[Name() + "reactor"] = new(UnitTypes.TERRAN_FACTORYREACTOR, UnitTypes.TERRAN_FACTORY, UnitTypes.TERRAN_STARPORT, true);
    ...
    private void Opening(int frame)
    {
        ...
        if (UnitCountService.EquivalentTypeCompleted(UnitTypes.TERRAN_FACTORY) > 0)
        {
            ...
            if (MacroData.DesiredAddOnCounts[UnitTypes.TERRAN_FACTORYREACTOR] < 1) MacroData.DesiredAddOnCounts[UnitTypes.TERRAN_FACTORYREACTOR] = 1; // build reactor on the factory as starport is building
        }
